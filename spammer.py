...
####--####88  8888   888  8888   88####--####
###----###88        8888        888###----###
##--##--##8888888888888888888888888##--##--##'''+Style.RESET_ALL+Fore.RED+'''
#--####--#8888888888888888888888888#--####--#
##--##--##88    @Mrxanon         88##--##--##
###----###88    @NexlsHere       88###----###
####--####88    SMS Spammer      88####--####
...
#############################################'''+Style.RESET_ALL
	def main():
		...
		while True:
			os.system("clear")
			print(logo)
			print (Fore.BLUE+"1) SMS Spammer\n2) Update Spammer\n3) Exit\n"+Style.RESET_ALL)
			input1 = input(Fore.BLUE+"Enter number: "+Style.RESET_ALL)
			if input1 == "1":
				try:
					print('Enter phone ("Enter" - exit):')
					phone = input(Fore.BLUE+"Spammer > "+Style.RESET_ALL)
					try:
							_phone=phone
							if _phone[0] == '+':
								_phone = _phone[1:]
							...
							while iteration < 2:
								try:
									...
									info = Fore.RED+"\nSpammer stopped\nPhone: {}".format(phone)+Style.RESET_ALL
									main()
								except:
									pass
							info = Fore.BLUE+"\nDone\nPhone: {}".format(phone)+Style.RESET_ALL
						...
						info = Fore.RED+"\nPhone number entered incorrectly!"+Style.RESET_ALL
				except KeyboardInterrupt:
					info = Fore.RED+"\Canceled!"+Style.RESET_ALL
				except:
					info = Fore.RED+"\nIncorrect data entry!"+Style.RESET_ALL
